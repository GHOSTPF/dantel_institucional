      ...
      <div className="relative z-10">
        ...
        <main className="grid grid-cols-1 lg:grid-cols-2 gap-12 px-12 mt-20 items-center">
          ...
          <div className="relative">
            <div className="relative z-20 border-[10px] border-[#1a1a1a] shadow-2xl overflow-hidden grayscale-[0.2] hover:grayscale-0 transition duration-700">
              <img 
                src="https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&q=80&w=800" 
                alt="Executivo Focado" 
                className="w-full h-[500px] object-cover object-top"
              />
              <div className="absolute bottom-0 left-0 bg-black/60 backdrop-blur-md p-6 text-sm">
                <p className="font-serif italic text-lg text-white">Liderança em Decisões</p>
                <p className="text-[10px] uppercase tracking-widest opacity-70">Sua empresa focada no crescimento estratégico.</p>
              </div>
            </div>
